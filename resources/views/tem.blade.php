...
<head>
    ...
    <title>Desktop App - SB Admin Pro</title>
        ...
        <div id="layoutDefault_content">
            <main>
                <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                    <div class="container">
                        <a class="navbar-brand text-primary" href="index.html">SB UI Kit Pro</a><button
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto mr-lg-5">
                                ...
                                <li class="nav-item dropdown dropdown-xl no-caret">
                                    <a class="nav-link dropdown-toggle" id="navbarDropdownDemos" href="#"
                                        ...
                                        aria-expanded="false">Landings<i
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <a class="dropdown-item" href="landing-app-mobile.html">Mobile
                                                            App</a><a class="dropdown-item"
                                                            href="landing-app-desktop.html">Desktop App</a>
                                                        <div class="dropdown-divider border-0"></div>
                                                        <h6 class="dropdown-header text-primary">Business</h6>
                                                        <a class="dropdown-item"
                                                            href="landing-multipurpose.html">Multipurpose</a><a
                                                            class="dropdown-item"
                                                            href="landing-agency.html">Agency</a><a
                                                            class="dropdown-item" href="landing-press.html">Press</a><a
                                                            class="dropdown-item"
                                                            href="landing-directory.html">Directory</a><a
                                                            class="dropdown-item"
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <a class="dropdown-item" href="header-basic.html">Basic</a><a
                                                            ...
                                                            href="header-graphic.html">Graphic</a><a
                                                            class="dropdown-item"
                                                            href="header-graphic-signup.html">Graphic (Signup)</a><a
                                                            class="dropdown-item" href="header-inner-page.html">Inner
                                                            Page</a><a class="dropdown-item"
                                                            href="header-nav-only.html">Nav Only</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-lg-6 p-lg-5">
                                                ...
                                                <a class="dropdown-item" href="page-basic.html">Basic Page</a><a
                                                    ...
                                                    class="dropdown-item"
                                                    href="page-company-pricing.html">Pricing</a><a
                                                    class="dropdown-item"
                                                    href="page-company-contact.html">Contact</a><a
                                            ...
                                            <div class="col-lg-6 p-lg-5">
                                                ...
                                                <a class="dropdown-item" href="page-portfolio-grid.html">Grid</a><a
                                                    ...
                                                    href="page-portfolio-masonry.html">Masonry</a><a
                                ...
                                <li class="nav-item dropdown no-caret">
                                    <a class="nav-link dropdown-toggle" id="navbarDropdownDocs" href="#"
                                        role="button" data-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">Documentation<i
                                            class="fas fa-chevron-right dropdown-arrow"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right animated--fade-in-up"
                            ...
                            <a class="btn-primary btn rounded-pill px-4 ml-lg-4"
                                href="https://shop.startbootstrap.com/sb-ui-kit-pro">Buy Now<i
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-xl-8 col-lg-10 text-center" data-aos="fade">
                                    <h1 class="page-header-title">Introducing a full suite of premium products</h1>
                                    <p class="page-header-text">Build a marketing site for your desktop app with this
                                        easy to use layout included with SB UI Kit Pro</p>
                                    <button class="btn btn-primary btn-marketing rounded-pill lift lift-sm">Get
                                        Started</button><button class="btn btn-link btn-marketing rounded-pill">Learn
                                        More</button>
                                </div>
                            </div>
                        </div>
                ...
                <section class="bg-light pb-10 pt-1">
                    <div class="container">
                        <div class="device-laptop text-gray-200 mt-n10" data-aos="fade-up">
                            ...
                            </svg><img class="device-screenshot" src="assets/img/app-desktop-demo-screenshot.jpg" />
                        </div>
                    </div>
                </section>
                ...
                <section class="bg-white py-10">
                    <div class="container">
                        <div class="row align-items-center justify-content-center">
                            <div class="col-lg-6">
                                <div class="badge badge-primary-soft text-primary badge-marketing badge-pill mb-3">Get
                                    Started!</div>
                                <div class="mb-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <a class="small text-arrow-icon" href="#!">Learn More<i
                            ...
                            <div class="col-md-9 col-lg-6" data-aos="slide-left">
                                <div class="mb-4">
                                    <div class="content-skewed content-skewed-left"><img
                                            class="img-fluid content-skewed-item shadow-lg rounded-lg"
                                            src="assets/img/app-desktop-demo-screenshot.jpg" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row z-1">
                            <div class="col-lg-4 mb-5 mb-lg-n10" data-aos="fade-up" data-aos-delay="100">
                                <div class="card pricing h-100">
                                    <div class="card-body p-5">
                                        <div class="text-center">
                                            <div class="badge badge-light badge-pill badge-marketing badge-sm">Free
                                            </div>
                                            <div class="pricing-price"><sup>$</sup>0<span
                                                    class="pricing-price-period">/mo</span></div>
                                        </div>
                                        <ul class="fa-ul pricing-list">
                                            ...
                                            <li class="pricing-list-item">
                                                <span class="fa-li"><i
                                                        class="far fa-circle text-gray-200"></i></span>Style customizer
                                            </li>
                                            <li class="pricing-list-item">
                                                <span class="fa-li"><i
                                                        class="far fa-circle text-gray-200"></i></span>Custom
                                                components
                                            </li>
                                            <li class="pricing-list-item">
                                                <span class="fa-li"><i
                                                        class="far fa-circle text-gray-200"></i></span>Expanded
                                                utilities
                                            </li>
                                            <li class="pricing-list-item">
                                                <span class="fa-li"><i
                                                        class="far fa-circle text-gray-200"></i></span>Third-party
                                                integration
                                            </li>
                                            <li class="pricing-list-item">
                                                <span class="fa-li"><i
                                                        class="far fa-circle text-gray-200"></i></span>Layout options
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-5">
                                        <div class="text-center">
                                            <div
                                                ...
                                                Standard</div>
                                            <div class="pricing-price"><sup>$</sup>19<span
                                                    class="pricing-price-period">/mo</span></div>
                                        </div>
                                        <ul class="fa-ul pricing-list">
                                            <li class="pricing-list-item">
                            ...
                            <div class="col-lg-4 mb-lg-n10" data-aos="fade-up" data-aos-delay="100">
                                <div class="card pricing h-100">
                                    <div class="card-body p-5">
                                        <div class="text-center">
                                            <div class="badge badge-light badge-pill badge-marketing badge-sm">
                                                Enterprise</div>
                ...
                <section class="bg-dark pb-10 pt-15">
                    <div class="container">
                            ...
                            <div class="col-lg-6 mb-5">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-white-50">Yes! You can use SB UI Kit Pro for client projects.
                                            There are two types of licenses available depending on what you're trying to
                                            do.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 mb-5">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-white-50">Yes! If you're not happy with your product then we
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex h-100">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <p class="text-white-50">When purchasing an HTML based product from Start
                                            Bootstrap, you get the HTML and CSS which you can bring into any framework.
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row justify-content-center text-center">
                            <div class="col-lg-8">
                                <div class="badge badge-transparent-light badge-pill badge-marketing mb-4">Get Started
                                </div>
                                ...
                                <p class="lead text-white-50 mb-5">Start Bootstrap's premium UI Kit beautifully and
                                    ...
                                    project!</p>
                                <a class="btn btn-teal btn-marketing rounded-pill lift lift-sm" href="#!">Buy
                                    Now!</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="input-group mb-2">
                                    ...
                                    <div class="input-group-append"><button class="btn btn-primary"
                                            id="button-addon2" type="button">Sign up</button></div>
                                </div>

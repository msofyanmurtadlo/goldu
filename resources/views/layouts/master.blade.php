...
<head>
    ...
    <meta name="description"
        content="{{ $settings['Site_Description'] ?? 'Enhance your affiliate marketing success with our private affiliate network. Create customized links, access comprehensive reports, and maximize your earnings. Join us today!' }}">
    ...
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/css/core/libs.min.css" />

    <!-- Aos Animation Css -->
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/vendor/aos/dist/aos.css" />

    <!-- Hope Ui Design System Css -->
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/css/hope-ui.min.css?v=2.0.0" />

    <!-- Custom Css -->
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/css/custom.min.css?v=2.0.0" />

    <!-- Dark Css -->
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/css/dark.min.css" />

    <!-- Customizer Css -->
    <link rel="stylesheet" href="{{ asset('template/dashboard/assets') }}/css/customizer.min.css" />
...
<body class="  ">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/01.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/01.png"
                                alt="ltr" class="mode light-img img-fluid btn-border p-0 flex-column active mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="ltr">
                            <span class=" mt-2"> LTR </span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/02.png"
                                alt="" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="dir-mode" data-name="dir" data-value="rtl">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/02.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-3 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/03.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/03.png"
                                alt="mini" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-type" data-value="sidebar-mini">
                            <span class="mt-2">Mini</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/04.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/04.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/05.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/05.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 mb-4">
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/06.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/06.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/07.png"
                                alt="rounded-all"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/07.png"
                                alt="rounded-all"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/08.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/09.png"
                                alt="pill-one-side" class="mode light-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="sidebar" data-name="sidebar-item" data-value="navs-pill">
                            <span class="mt-2">Pill One Side</span>
                        </div>
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/09.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/08.png"
                    ...
                    <div class="d-grid gap-3 grid-cols-2 ">
                        <div class=" text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/11.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/10.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/10.png"
                            ...
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/11.png"
                        ...
                        <div class=" text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/12.png"
                                alt="sticky" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-sticky">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/12.png"
                        ...
                        <div class="text-center">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/dark/13.png"
                                alt="transparent" class="mode dark-img img-fluid btn-border p-0 flex-column mb-2"
                                data-setting="navbar" data-target=".iq-navbar" data-name="navbar-type"
                                data-value="navs-transparent">
                            <img src="{{ asset('template/dashboard/assets') }}/images/settings/light/13.png"
    ...
    <script src="{{ asset('template/dashboard/assets') }}/js/core/external.min.js"></script>

    <!-- Widgetchart Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/charts/widgetcharts.js"></script>

    <!-- mapchart Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/charts/vectore-chart.js"></script>
    <script src="{{ asset('template/dashboard/assets') }}/js/charts/dashboard.js"></script>

    <!-- fslightbox Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/plugins/fslightbox.js"></script>

    <!-- Settings Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/plugins/setting.js"></script>

    <!-- Slider-tab Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/plugins/slider-tabs.js"></script>

    <!-- Form Wizard Script -->
    <script src="{{ asset('template/dashboard/assets') }}/js/plugins/form-wizard.js"></script>

    <!-- AOS Animation Plugin-->
    <script src="{{ asset('template/dashboard/assets') }}/vendor/aos/dist/aos.js"></script>
